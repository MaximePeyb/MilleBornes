...
public enum Type {
	...
	Type(String attaque, String parade, String botte){
		msgAttaque = attaque; msgParade = parade; msgBotte = botte;
	}
	public String attaque() { return msgAttaque; }
	public String parade() { return msgParade; }
	public String botte() { return msgBotte; }
}
